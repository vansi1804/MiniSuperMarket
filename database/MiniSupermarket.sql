...
USE MiniSuperMarket
GO
/****** Object:  Table [dbo].[Xuat_Hang]    Script Date: 1/4/2022 2:19:41 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Mat_Hang]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[DoanhThu]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[TonKho]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Loai_Tien]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Loai_Giao_Dich]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Nha_Cung_Cap]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[NhapHang]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Dat_Hang]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Khach_Hang]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Nhan_Vien]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Nhom_Nguoi_Dung]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Phan_Nhom]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Phan_Quyen]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Quay_Giao_Dich]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Quyen]    Script Date: 1/4/2022 2:19:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Dat_Hang] ([MaPhieu], [MaMH], [MaKH], [SoLuong], [GiaBan], [ThanhTien], [NgayDat], [ThanhToan], [MaLoaiTien], [MaLoaiGiaoDich], [GhiChu]) VALUES (N'DH000004', N'MH000006', N'KH000004', 1, 18900000, 18900000, CAST(N'2021-12-14T00:00:00.000' AS DateTime), 0, N'0001', N'GD0002', N'')
GO
...
GO
INSERT [dbo].[Mat_Hang] ([MaPhieu], [MaMH], [TenMH], [SoLuong], [DonGia], [GiaBan], [MaNCC], [NgayNhap], [MaLoaiTien], [MaLoaiGiaoDich]) VALUES (N'NH000001', N'MH000001', N'Laptop Vaio', 50, 20000000, 21000000, N'NCC000001', CAST(N'2021-11-01T00:00:00.000' AS DateTime), N'0001', N'GD0002')
GO
...
GO
INSERT [dbo].[Mat_Hang] ([MaPhieu], [MaMH], [TenMH], [SoLuong], [DonGia], [GiaBan], [MaNCC], [NgayNhap], [MaLoaiTien], [MaLoaiGiaoDich]) VALUES (N'NH000003', N'MH000003', N'Đầu DVD', 50, 1500000, 1700000, N'NCC000001', CAST(N'2021-11-23T00:00:00.000' AS DateTime), N'0001', N'GD0001')
GO
...
GO
INSERT [dbo].[Nhan_Vien] ([MaNV], [HoTenNV], [NgaySinh], [DiaChi], [DienThoai], [MaQuayGiaoDich]) VALUES (N'NV000001', N'Ngô Chung Kiên', CAST(N'1990-09-09T00:00:00.000' AS DateTime), N'Xuân Mai - Chương Mỹ - Hà Nội', N'0979389350', N'MT01')
GO
INSERT [dbo].[Nhan_Vien] ([MaNV], [HoTenNV], [NgaySinh], [DiaChi], [DienThoai], [MaQuayGiaoDich]) VALUES (N'NV000002', N'Nguyễn Hùng Mạnh', CAST(N'1989-07-08T00:00:00.000' AS DateTime), N'Xuân Mai - Chương Mỹ - Hà Nội', N'0973302655', N'DT01')
GO
INSERT [dbo].[Nhan_Vien] ([MaNV], [HoTenNV], [NgaySinh], [DiaChi], [DienThoai], [MaQuayGiaoDich]) VALUES (N'NV000003', N'Nguyễn Thị Ngọc', CAST(N'1990-03-06T00:00:00.000' AS DateTime), N'Xuân Mai - Chương Mỹ - Hà Nội', N'0988692854', N'QA01')
GO
INSERT [dbo].[Nhan_Vien] ([MaNV], [HoTenNV], [NgaySinh], [DiaChi], [DienThoai], [MaQuayGiaoDich]) VALUES (N'NV000004', N'Ngô Thanh Thành', CAST(N'1990-12-20T00:00:00.000' AS DateTime), N'Xuân Mai - Chương Mỹ - Hà Nội', N'0988767656', N'KTS01')
GO
INSERT [dbo].[Nhan_Vien] ([MaNV], [HoTenNV], [NgaySinh], [DiaChi], [DienThoai], [MaQuayGiaoDich]) VALUES (N'NV000005', N'Nguyễn Thị Oanh', CAST(N'1990-10-05T00:00:00.000' AS DateTime), N'Nhân Hòa - Nhân Chính - Hà Nội', N'01663736342', N'DT02')
GO
INSERT [dbo].[Nhan_Vien] ([MaNV], [HoTenNV], [NgaySinh], [DiaChi], [DienThoai], [MaQuayGiaoDich]) VALUES (N'NV000006', N'Phạm Trung Dũng', CAST(N'1987-12-04T00:00:00.000' AS DateTime), N'Đống Đa - Hà Nội', N'0912897287', N'HS01')
GO
...
GO
INSERT [dbo].[Phan_Quyen] ([MaQuyen], [MaNhomNguoiDung], [MaNV], [MatKhau], [TenDangNhap]) VALUES (N'MQ001', N'PHGCC', N'NV000001', N'kien', N'admin')
GO
INSERT [dbo].[Phan_Quyen] ([MaQuyen], [MaNhomNguoiDung], [MaNV], [MatKhau], [TenDangNhap]) VALUES (N'MQ001', N'PHGKH', N'NV000004', N'thanh', N'thanh')
GO
INSERT [dbo].[Phan_Quyen] ([MaQuyen], [MaNhomNguoiDung], [MaNV], [MatKhau], [TenDangNhap]) VALUES (N'MQ002', N'PHGTT', N'NV000002', N'manh', N'manh')
GO
...
GO
INSERT [dbo].[Xuat_Hang] ([MaPhieu], [MaMH], [MaKH], [MaNV], [SoLuong], [GiaBan], [ThanhTien], [NgayXuat], [MaLoaiTien], [MaLoaiGiaoDich]) VALUES (N'XH000002', N'MH000002', N'KH000002', N'NV000005', 1, 13900000, 13900000, CAST(N'2021-11-08T00:00:00.000' AS DateTime), N'0001', N'GD0001')
GO
...
GO
INSERT [dbo].[Xuat_Hang] ([MaPhieu], [MaMH], [MaKH], [MaNV], [SoLuong], [GiaBan], [ThanhTien], [NgayXuat], [MaLoaiTien], [MaLoaiGiaoDich]) VALUES (N'XH000004', N'MH000004', N'KH000004', N'NV000005', 1, 13900000, 13900000, CAST(N'2021-12-16T00:00:00.000' AS DateTime), N'0001', N'GD0001')
GO
INSERT [dbo].[Xuat_Hang] ([MaPhieu], [MaMH], [MaKH], [MaNV], [SoLuong], [GiaBan], [ThanhTien], [NgayXuat], [MaLoaiTien], [MaLoaiGiaoDich]) VALUES (N'XH000005', N'MH000005', N'KH000005', N'NV000005', 2, 13000000, 13000000, CAST(N'2021-12-16T00:00:00.000' AS DateTime), N'0001', N'GD0002')
GO
...
GO
INSERT [dbo].[Xuat_Hang] ([MaPhieu], [MaMH], [MaKH], [MaNV], [SoLuong], [GiaBan], [ThanhTien], [NgayXuat], [MaLoaiTien], [MaLoaiGiaoDich]) VALUES (N'XH000007', N'MH000007', N'KH000001', N'NV000005', 1, 16900000, 16900000, CAST(N'2021-12-16T00:00:00.000' AS DateTime), N'0001', N'GD0003')
GO
